// backend/src/utils/semesterUtils.ts
/**
 * Calculate the current week and semester break status based on dates
 *
 * Semester structure (14 weeks):
 * - Week 1-7: Days 0-48 (49 days)
 * - Sem Break: Days 49-55 (7 days) - BETWEEN Week 7 and Week 8
